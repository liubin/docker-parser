...
$white_list = ['docker', 'dockerfile', 'eof', 'systemd', 'namespace', 'init',
  ...
  'e2e', 'k8s', 'env', 'apiserver', 'nfs', 'rpc', 'prometheus', 'grpc', 'etcd',
  'kubectl', 'kubeadm', 'kubernetes', 'hostname', 'autogenerated', 'configmap',
  'addon', 'selinux', 'ceph', 'aws', 'kubedns'
]
...
def spell_check_file file
  ...
  href = "https://github.com/kubernetes/#{$repo}/blob/master#{file.sub($root + "/" + $repo, '')}"
